    ...
    return (
        <Container sx={{ height: '100vh' }}>
            <Paper elevation={3} sx={{ padding: '1rem 4rem', borderRadius: '1rem', margin: 'auto', width: '100%', overflow: 'hidden', height: '100%', boxShadow:'none' }}>
                ...
                <DataGrid rows={rows} columns={cols} rowHeight={rowHeight} disableColumnMenu disableColumnSelector disableDensitySelector disableSelectionOnClick style={{ height: '80%' }} sx={{border: 'none', '.table-header': {
